...
--drop table preview.user_role;
create table preview.user_role (
...
insert into preview.user_role (user_role_number, user_role_name) values (1, 'Admin');
insert into preview.user_role (user_role_number, user_role_name) values (2, 'Student');
insert into preview.user_role (user_role_number, user_role_name) values (3, 'Guest');


--drop table preview.site_user;
create table preview.site_user (
...
insert into preview.site_user (user_name, user_email, user_first_name, user_last_name, user_role_number)
    values ('ron31416', 'ron31416@gmail.com', 'Ron', 'Rice', 1)


--drop table preview.skill_level;
create table preview.skill_level (
...
insert into preview.skill_level (skill_level_number, skill_level_name) values (1, 'Beginner');
insert into preview.skill_level (skill_level_number, skill_level_name) values (2, 'Intermediate');
insert into preview.skill_level (skill_level_number, skill_level_name) values (3, 'Advanced');


--drop table preview.song
create table preview.song (
  ...
  constraint fk_skill_level foreign key (
    ...
    references preview.skill_level (
      skill_level_number
    ),
