...
export const SONGS = [
  ...
  { title: "arabesque-l-66-no-1-in-e-major", src: "/scores/arabesque-l-66-no-1-in-e-major.mxl" },
  { title: "ave-maria-d839-schubert-solo-piano-arrg", src: "/scores/ave-maria-d839-schubert-solo-piano-arrg.mxl" },
  { title: "beethoven-symphony-no-5-1st-movement-piano-solo", src: "/scores/beethoven-symphony-no-5-1st-movement-piano-solo.mxl" },
  { title: "canon-in-d", src: "/scores/canon-in-d.mxl" },
